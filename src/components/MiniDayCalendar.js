...
function MiniDayCalendar() {
  ...
  return (
    <Card sx={{ p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'rgba(30,32,60,0.9)', borderRadius: 3, minWidth: 220, width: '100%', height: 420, maxWidth: 270 }}>
