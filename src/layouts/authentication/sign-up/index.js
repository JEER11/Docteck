          ...
          <Stack mb="25px" justifyContent="center" alignItems="center" direction="row" spacing={2}>
            {enableFacebook && (
              <GradientBorder borderRadius="xl">
                <IconButton
                  onClick={() => handleSocialSignin(async () => { await signinWithFacebook(); history.push('/profile'); })}
                  disabled={submitting}
                  sx={{
                    background: '#0b1022',
            ...
            {enableMicrosoft && (
              <GradientBorder borderRadius="xl">
                <IconButton
                  onClick={() => handleSocialSignin(async () => { await signinWithMicrosoft(); history.push('/profile'); })}
                  disabled={submitting}
                  sx={{
                    background: '#0b1022',
                    border: '2px solid #23263a',
            ...
            {enableGoogle && (
              <GradientBorder borderRadius="xl">
                <IconButton
                  onClick={() => handleSocialSignin(async () => { await signinWithGoogle(); history.push('/profile'); })}
                  disabled={submitting}
                  sx={{
                    background: '#0b1022',
                    border: '2px solid #23263a',
            ...
            {enableYahoo && (
              <GradientBorder borderRadius="xl">
                <IconButton
                  onClick={() => handleSocialSignin(async () => { await signinWithYahoo(); history.push('/profile'); })}
                  disabled={submitting}
                  sx={{
                    background: '#0b1022',
                    border: '2px solid #23263a',
